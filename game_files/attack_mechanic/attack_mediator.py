...
def compute_player_dealt_damage_to_mob(
    player_character: Player, monster_list: list, attacked_monster_index: int
) -> None:
...
def compute_mob_dealt_damage_to_player(attacking_monster: Monster, player_character: Player) -> None:
