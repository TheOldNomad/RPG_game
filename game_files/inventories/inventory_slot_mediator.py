...
def list_all_items(player_character: Player) -> None:
...
def hand_over_item_to_active_slot(equipable_item: Item, player_character: Player) -> None:
...
def get_item_from_active_slot(item_to_remove: Weapon | Armor, player_character: Player) -> None:
